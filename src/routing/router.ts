...
import {IFileInfo, IUpdateFilesOptions, IStores, IUpdatedFiles, IRequestFileInfo} from "../storage";
...
export type ApiRouterContext<D extends DataWrapper, U = any, E = any> = {
    ...
    drivers: IDrivers;
    stores: IStores;
    getFile     : () => IRequestFileInfo;
    getFiles    : () => IRequestFileInfo[];
    getFileNamesToRemove : () => string[];
    getExistingFiles: () => IRequestFileInfo[];
